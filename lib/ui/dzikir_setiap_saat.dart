        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              ItemMenu(jumlah: '33 X', arab: 'أَسْتَغْفِرُ ٱللَّٰه', latin: 'Astagfirullah'),
              SizedBox(height: edge),
              ItemMenu(jumlah: '33 X', arab: 'سُبْحَانَ ٱللَّٰه', latin: 'Subhanallah'),
              SizedBox(height: edge),
              ItemMenu(jumlah: '33 X', arab: 'اَلْحَمْدُ للَّه', latin: 'Alhamdulillah'),
              SizedBox(height: edge),
              ItemMenu(jumlah: '33 X', arab: 'لا إله إلا الله', latin: 'Lailahaillallah'),
              SizedBox(height: edge),
              ItemMenu(jumlah: '33 X', arab: 'الله اكبر', latin: 'Allahuakbar'),
            ],
          ),
        ),
      ),
